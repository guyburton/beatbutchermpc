...
{
   public static final long serialVersionUID = 79634l;
   ...
   public void layoutContainer(Container target)
   {
      synchronized (target.getTreeLock())
      {
         ...
         placeComponents(south, left, bottom - southHeight,
               right - left, southHeight, HORIZONTAL);
         bottom -= (southHeight + getVgap());
 
 
         placeComponents(east, right - eastWidth, top,
               eastWidth, bottom - top, VERTICAL);
         right -= (eastWidth + getHgap());
 
 
         placeComponents(west, left, top, westWidth,
                  bottom - top, VERTICAL);
   ...
   private void placeComponents(ArrayList<Component> comps,
